			...
			<div class="main-container">
					<div class="pd-ltr-20 xs-pd-20-10">
						<div class="min-height-200px">
							...
							<form class="html-editor pd-20 card-box mb-30" method="post" action="action-Insert/Insert-work.php">
								...
								<div class="form-group row">
									...
									<div class="col-sm-12 col-md-12">
										<input class="form-control" type="text" placeholder="Title Name" name="Title_work_en">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-12 col-md-12 col-form-label">Title_work(ar)</label>
									<div class="col-sm-12 col-md-12">
										<input class="form-control" type="text" placeholder="Title Name" name="Title_work_ar">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-12 col-md-12 col-form-label">Title_work(fr)</label>
									<div class="col-sm-12 col-md-12">
										<input class="form-control" type="text" placeholder="Title Name" name="Title_work_fr">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="form-group">
										<button type="submit" class="btn btn-primary" name="submit">Add Work </a>
									</div>
							</form>
						</div>
