						...
						<table class="data-table table stripe hover nowrap">
							...
							<tbody>
								<?php
									...
									$Testemonials = new Posts();

									$getTestemonials = $Testemonials->get_post(null , 'posts');
												...
												<tr>
														...
														<div class="dropdown">
															...
															<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
																<a class="dropdown-item" href="blogs.php?do=<?php echo 'Edit'?>&id=<?php echo $id ?>"><i class="dw dw-edit2"></i> Edit</a>
																<a class="dropdown-item" href="Action_Delete/delete_blog.php?id=<?php echo $id  ?>"><i class="dw dw-delete-3"></i> Delete</a>
															</div>
														</div>
													</td>
												</tr>
