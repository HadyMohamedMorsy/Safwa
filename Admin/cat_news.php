		...
		<?php
			...
			<?php
				...
				if(isset($_GET['id'])){
					...
					$gettest = $test->get_cat('id' , 'news_catagory');
							...
							<div class="main-container">
								<div class="pd-ltr-20 xs-pd-20-10">
									<div class="min-height-200px">
										...
										<form class="html-editor pd-20 card-box mb-30" method="post" action="action_Edit/Edit-cat_news.php">
											<h2 class="h4 text-blue">Edit Cat-new </h2>
											<a href="cat_news.php" class="btn btn-primary">Add Catagory News  </a>

											<div class="form-group row">
												<label class="col-sm-12 col-md-12 col-form-label">Catagory-News(en)</label>
												<div class="col-sm-12 col-md-12">
													<input class="form-control" type="text" placeholder="Title_en" name="cat_post_en" value="<?php echo $title_cat_en; ?>">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-12 col-md-12 col-form-label">Catagory-News(ar)</label>
												<div class="col-sm-12 col-md-12">
													<input class="form-control" type="text" placeholder="Title_ar" name="cat_post_ar" value="<?php echo $title_cat_ar; ?>">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-12 col-md-12 col-form-label">Catagory-News(fr)</label>
												<div class="col-sm-12 col-md-12">
											...
											<div class="form-group">
												...
												<button type="submit" class="btn btn-primary" name="submit">Edit Cat News </a>
											</div>
										</form>
									</div>
									<div class="footer-wrap pd-20 mb-20 card-box">
