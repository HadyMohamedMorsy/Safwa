		...
		<?php
			...
			<?php
				...
				if(isset($_GET['id'])){
					...
					$getworks = $get_data->get_post('id',"events");
							...
							<div class="main-container">
								<div class="pd-ltr-20 xs-pd-20-10">
									<div class="min-height-200px">
										...
										<form class="html-editor pd-20 card-box mb-30" method="post" action="./action_Edit/Edit_events.php">
											<h2 class="h4 text-blue">Edit Event </h2>
											<a href="blogs.php" class="btn btn-primary">Add Event </a>
											...
											<div class="form-group">
												...
												<div class="form-group">
													...
													<button type="submit" class="btn btn-primary" name="submit">Edit Event </a>
												</div>
										</form>
