						...
						<table class="data-table table stripe hover nowrap">
							...
							<tbody>
								<?php
									...
									$getTestemonials = $Testemonials->getTestemonials();
												...
												<tr>
														...
														<div class="dropdown">
															...
															<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
																<a class="dropdown-item" href="testemonials.php?do=<?php echo 'Edit'?>&id=<?php echo $Testemonial_id ?>"><i class="dw dw-edit2"></i> Edit</a>
																<a class="dropdown-item" href="Action_Delete/delete_testemonials.php?id=<?php echo $Testemonial_id ?>"><i class="dw dw-delete-3"></i> Delete</a>
															</div>
														</div>
													</td>
												</tr>
