						...
						<table class="data-table table stripe hover nowrap">
							...
							<tbody>
								<?php
									...
									$getTestemonials = $Testemonials->get_post(null , 'news');
												...
												<tr>
														...
														<div class="dropdown">
															...
															<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
																<a class="dropdown-item" href="news.php?do=<?php echo 'Edit'?>&id=<?php echo $id ?>"><i class="dw dw-edit2"></i> Edit</a>
																<a class="dropdown-item" href="Action_Delete/delete_news.php?id=<?php echo $id  ?>"><i class="dw dw-delete-3"></i> Delete</a>
															</div>
														</div>
													</td>
												</tr>
